...
<head>
	...
	<link rel="icon" href="{{ asset('frontend_assets/Training') }}/images/icon1.png">
	<title>Tarining &amp; Capacity Building</title>
	...
	<link rel="stylesheet" href="{{ asset('frontend_assets/Training') }}/css/all.min.css">
	<link rel="stylesheet" href="{{ asset('frontend_assets/Training') }}/css/bootstrap.min.css">
	<link rel="stylesheet" href="{{ asset('frontend_assets/Training') }}/css/animate.css">
	<link rel="stylesheet" href="{{ asset('frontend_assets/Training') }}/css/style.css">
	<link rel="stylesheet" href="{{ asset('frontend_assets/Training') }}/css/responsive.css">
  ...
  @yield('frontend_main')
	...
	<script src="{{ asset('frontend_assets/Training') }}/js/jquery-1.12.4.min.js"></script>
	<script src="{{ asset('frontend_assets/Training') }}/js/popper.min.js"></script>
	<script src="{{ asset('frontend_assets/Training') }}/js/bootstrap.min.js"></script>
	<script src="{{ asset('frontend_assets/Training') }}/js/waypoints.min.js"></script>
	<script src="{{ asset('frontend_assets/Training') }}/js/wow.min.js"></script>
	<script src="{{ asset('frontend_assets/Training') }}/js/custom.js"></script>
	<script src="https://kit.fontawesome.com/c218529370.js"></script>
</body>
