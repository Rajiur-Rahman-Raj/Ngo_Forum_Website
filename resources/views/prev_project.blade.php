...
@section('frontend_main')
	<style>
		.latest_banner {
			background-image: url({{ asset('frontend_assets') }}/images/p-25.jpg);
...
<body>
	...
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">Implemented Projects</li>
		</ol>
	</nav>
	<!--link part end-->
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="hardware_headeing">
							<h3>Overview of <span>Implemented Projects :</span></h3>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="water mb-4">
			<div class="container">
				<table id="table_id" class="display table-striped">
					...
					<tbody>
					    <?php $sl_number = 1 ?>
						@foreach ($implemented_infos as $implemented_info)
						...
						<tr>
							...
							<td>
								<div class="water_text">
									<h5>{{ $implemented_info->project_name }}</h5>
								</div>
							</td>
							<td>
								<div class="water_text">
									<p>{{ $implemented_info->year }}</p>
								</div>
							</td>
							<td>
								<div class="water_text">
									<p>{{ $implemented_info->project_donor }}</p>
								</div>
							</td>
							<td>
								<div class="water_text">
									<p>{{ $implemented_info->thematic_area }}</p>
								</div>
							</td>
							<td style="width:80px">
								<div class="water_text">
									<a href="{{ url('implemented/project/details') }}/{{ $implemented_info->id }}"><i class="fas fa-bars"></i> Details</a>
								</div>
							</td>
